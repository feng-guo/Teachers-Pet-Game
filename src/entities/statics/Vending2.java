...
public class Vending2 extends StaticEntity{
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.vending2, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
