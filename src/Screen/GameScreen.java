...
public class GameScreen extends AbstractScreen{
	...
	public GameScreen(FinalGame app) {
		...
		grass1 = new Texture("images/sprites/grass_1.png");
		grass2 = new Texture("images/sprites/grass_2.png");
		batch = new SpriteBatch();
		
		TextureAtlas atlas = app.getAssetManager().get("images/sprites/packed/feng_textures.atlas", TextureAtlas.class);
