...
public class ListOfMoves {
    ...
    ListOfMoves () {
        ...
        moveList.add(new StatChangeMove("Call Uber", 1.0, "Neutral", 2, "Speed", 10, 0));
        moveList.add(new StatChangeMove("Cram", 1.0, "Neutral", 2, "Intelligence", 5, 0));
        ...
        moveList.add(new AttackMove("Spam Calculator", 50, 1.0, "Math", "Attack", 15, 0));
        moveList.add(new HealthMove("Calculate Mark", "Math", 0, "Health", -2, 8, 0));
        moveList.add(new StatChangeMove("Mark Test", 1.0, "Math", 2, "Speed", 20, 0));
        //moveList.add(new )
    }
