...
public class BattleTester {
    public static void main(String[] args) {
        ...
        movesetFeng[0] = new AttackMove("Steal Code", 40, 1.0, "Technology", "Intelligence", 15, 0);
        movesetFeng[1] = new HealthMove("Snort Candy", "English", 1, "Health", 40, 20, 0);
        movesetFeng[2] = new AttackMove("Throw Chair", 80, 0.75, "Neutral", "Attack", 10, 0);
        movesetFeng[3] = new AttackMove("Stack Overflow", 30, 1.0, "Technology", "Intelligence", 20, 0);
